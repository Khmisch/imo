...
import com.example.imoaplication.adapter.ContactListAdapterDark
import com.example.imoaplication.model.Chat
import com.example.imoaplication.model.Contacts
import java.util.ArrayList

class ContactListFragmentDark: Fragment() {
    lateinit var nestedScrollView: NestedScrollView
    lateinit var recyclerView: RecyclerView
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {

        val view: View = inflater.inflate(R.layout.fragment_contact_list_dark_mode, container, false)
        initViews(view)
        return view
    }
