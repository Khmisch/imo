...
import com.example.imoaplication.adapter.ChatAdapterDark
import com.example.imoaplication.model.Chat
import java.util.ArrayList

class ChatsFragmentDark : Fragment() {
    lateinit var recyclerView: RecyclerView
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {

        val view: View = inflater.inflate(R.layout.fragment_chats_dark_mode, container, false)
        initViews(view)
        return view
    }
    ...
    private fun refreshAdapter(chats: ArrayList<Chat>) {
        val adapter = ChatAdapterDark(this, chats)
