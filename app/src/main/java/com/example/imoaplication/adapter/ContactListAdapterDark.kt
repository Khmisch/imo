...
class ContactListAdapterDark (var fragment: ContactListFragmentDark, var items: ArrayList<Contacts>): RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder{
        if (viewType == TYPE_ADDED_YES) {
            val view: View = LayoutInflater.from(parent.context).inflate(R.layout.item_contact_list_view_dark, parent, false)
            return AddedViewHolderYes(view)
        }
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_contact_list_view_invite_dark, parent, false)
